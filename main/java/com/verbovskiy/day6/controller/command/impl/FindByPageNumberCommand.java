...
public class FindByPageNumberCommand implements ActionCommand {
    @Override
    public Map<String, Object> execute(Map<String, Object> actionParameters) {
        Map<String, Object> response = new HashMap<>();
        LibraryService libraryService = new LibraryService();
        try {
            List<CustomBook> books = libraryService.findByPageNumber((int) actionParameters
                    .get(CommandParameter.NUMBER_OF_PAGE));
