...
import com.verbovskiy.day6.controller.command.impl.SortByNameCommand;
...
public class SortByNameCommandTest {
    ActionCommand sortByNameCommand;
    ...
    public void executePositiveTest() {
        ...
        Map<String, Object> actual = sortByNameCommand.execute(actionParameters);
